        ...
        <section className="mt-50 mb-50">
          <div className="container">
            <div className="row">
              ...
              {/* Tabs para numero de dias */ }
              <div >
                <div className="tab-header">
                  <ul className="nav nav-tabs" id="myTabs" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button
                        className={activeDay ==="1" ? "nav-link active" : "nav-link"}
                        onClick={()=>changeTabDay("1")}
                      >
                        Día 1
                      </button>
                    </li>
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        className={activeDay ==="2" ? "nav-link active" : "nav-link"}
                        onClick={()=>changeTabDay("2")}
                      >
                        Día 2
                      </button>
                    </li>
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        className={activeDay ==="3" ? "nav-link active" : "nav-link"}
                        onClick={()=>changeTabDay("3")}
                      >
                        Día 3
                      </button>
                    </li>
                    ...
                    <li className="nav-item" role="presentation">
                      <button
                        className={activeDay ==="4" ? "nav-link active" : "nav-link"}
                        onClick={()=>changeTabDay("4")}
                      >
                        Día 4
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        className={activeDay ==="5" ? "nav-link active" : "nav-link"}
                        onClick={()=>changeTabDay("5")}
                      >
                        Día 5
                      </button>
                    </li>
                    <li className="nav-item" role="presentation">
                      <button
                        className={activeDay ==="6" ? "nav-link active" : "nav-link"}
                        onClick={()=>changeTabDay("6")}
                      >
                        Día 6
                      </button>
                    </li>
                ...
                <div className="tab-content wow fadeIn animated">
                  <div className={ activeDay ==="1" ? "tab-pane fade show active" : "tab-pane fade"}>
                ...
                <div className={ activeDay ==="2" ? "tab-pane fade show active" : "tab-pane fade"}>
                  <div className="product-grid-4 row">
                    <div className="col-lg-12">
                      <div className="row product-grid-3">
                        {size(comida) === 0 && (
                ...
                <div className={ activeDay ==="3" ? "tab-pane fade show active" : "tab-pane fade"}>
                  <div className="product-grid-4 row">
                    <div className="col-lg-12">
                      <div className="row product-grid-3">
                        {size(cena) === 0 && (
                ...
                <div className={ activeDay ==="4" ? "tab-pane fade show active" : "tab-pane fade"}>
                  <div className="product-grid-4 row">
                    <div className="col-lg-12">
                      <div className="row product-grid-3">
                        {size(market) === 0 && (
                ...
                <div className={ activeDay ==="5" ? "tab-pane fade show active" : "tab-pane fade"}>
                  <div className="product-grid-4 row">
                    <div className="col-lg-12">
                      <div className="row product-grid-3">
                        {size(market) === 0 && (
                ...
                <div className={ activeDay ==="6" ? "tab-pane fade show active" : "tab-pane fade"}>
                  <div className="product-grid-4 row">
                    <div className="col-lg-12">
                      <div className="row product-grid-3">
                        {size(market) === 0 && (
              ...
              {/* Tabs para Menú diario del planner */}
              <div className="tab-header">
                <ul className="nav nav-tabs" id="myTabs" role="tablist">
                  <li className="nav-item" role="presentation">
                    <button
