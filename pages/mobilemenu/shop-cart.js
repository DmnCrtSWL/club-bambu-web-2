              ...
              <div className="col-12">
                <div className="table-responsive">
                  <div className="text-center">
                    <h1>Tu Orden</h1>
                    <p>Lista de productos que haz seleccionado. Por favor confirma tu orden.</p>
                    <br />
                  </div>
                  {cartItems.length <= 0 && (
                  ...
                  <table
                    className={
                      cartItems.length > 0
                        ? " shopping-summery text-center clean"
                        : "d-none"
                    }
                  >
                    {/*<thead>
                    ...
                    <tbody>
                      {cartItems.map((item, i) => (
                        <tr key={i}>
                          ...
                          <td className="action" data-title-hidden="Remove">
                            <a
                ...
                {totalCartItems > 0 && (
                  <div className="cart-action text-end">
                    <Link
                      ...
                      // }}
                    >
                      <a className="btn ">Confirma tu Orden</a>
                    </Link>
                  </div>
                )}
